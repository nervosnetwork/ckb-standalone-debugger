// Adapted from https://github.com/tikv/pprof-rs/blob/3fae96b88522f7ae6d6ba029f132d4365ecfa37e/src/timer.rs
#![allow(dead_code)]
...
unsafe extern "C" {
    unsafe fn setitimer(which: c_int, new_value: *mut Itimerval, old_value: *mut Itimerval) -> c_int;
}
